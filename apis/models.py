...
class Companies(models.Model):
    ...
    user = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True, related_name='company_user')
    ...
    open_user = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True, related_name='company_open_user')
    processing_user = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True, related_name='company_processing_user')
    approve_user = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True, related_name='company_approve_user')
    reimburse_user = models.ForeignKey('Users', on_delete=models.CASCADE, blank=True, null=True, related_name='company_reimburse_user')
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
...
class Expenses(models.Model):
    ...
    user = models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='expense_user')
    open_user = models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='expense_open_user')
    processing_user = models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='expense_processing_user')
    approve_user = models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='expense_approve_user')
    reimburse_user = models.ForeignKey(Users, on_delete=models.CASCADE, blank=True, null=True, related_name='expense_reimburse_user')
